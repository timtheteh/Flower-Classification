...
batch_size = 320  # You can adjust the batch size
...
optimizer = optim.SGD(model.parameters(), lr=0.0175, momentum=0.9)
...
for epoch in range(num_epochs):
    ...
    if validation_loss < best_validation_loss:
        ...
        torch.save(model.state_dict(), 'short_deform_flowers102.pth')
    else:
...
best_model_weights = torch.load('short_deform_flowers102.pth')
